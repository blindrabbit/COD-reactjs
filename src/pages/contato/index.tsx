...
import IFES from "../..//assets/img/ifes.png";
import "./style.css";
import AOS from "aos";
      ...
      <Navbartop />
        <div className="bloco-externo ">
              <Grid item xs={12} data-aos="fade-down">
                  <img src={IFES} className="img_test" alt=""></img>
              </Grid>
        <Grid container spacing={3}>
          <Grid item xs={4}>
            <Grid container spacing={2} direction="column">
              <Grid item xs={12} data-aos="fade-up">
                <h1>Vitor Soares Salzman</h1>
              </Grid>
            </Grid>
